...
- During development, you can load your package with `devtools::load_all()`
...
- `load_all` has advantages, though
    ...
    - I usually do this with packages that support a single analysis - I keep my scripts in the same folder as the R code, and just use `devtools::load_all()` to load the package
...
- Anyone can run `renv::install("user/package")` and get your package, if your Github repository is public
...
- The best way to distribute vignettes (and documentation) is through a [pkgdown](https://pkgdown.r-lib.org/) site
